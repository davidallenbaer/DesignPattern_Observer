...
namespace DesignPattern_Observer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //User Dave will be created and user1 object will be registered to the subject
            Observer user1 = new Observer("Dave", RedMI);
            //User Tom will be created and user1 object will be registered to the subject
            Observer user2 = new Observer("Tom", RedMI);
            //User Mitch will be created and user3 object will be registered to the subject
